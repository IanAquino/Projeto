...
class TabelaPacientes(db: SQLiteDatabase) {
    ...
    fun cria() {
        db.execSQL("CREATE TABLE $NOME_TABELA (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $CAMPO_NOME TEXT NOT NULL, $DATA_NASCIMENTO DATETIME NOT NULL, $CAMPO_CONTACTO TEXT NOT NULL, $MORADA TEXT NOT NULL, $NIF TEXT NOT NULL)")
    }
    ...
    companion object {
        ...
        val TODAS_COLUNAS = arrayOf(BaseColumns._ID, CAMPO_NOME, DATA_NASCIMENTO, CAMPO_CONTACTO, MORADA, NIF)
