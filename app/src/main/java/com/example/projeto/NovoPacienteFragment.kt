...
import java.util.*
 ...
 abstract class NovoPacienteFragment : Fragment(), LoaderManager.LoaderCallbacks <Cursor> {
    ...
    fun guardar(){
        ...
        val pacientes = Pacientes(nome = nome, nascimento = Date(nascimento), contacto = contacto, nif = nif)
